...
public List<Integer> findPlan(){
		...
		//you will have to fill the order object with the index of each triple in the computed order
		//e.g. if you do order.add(3), then order.add(5), then order.add(6) you will get the order 3,5,6 for 3 patterns
